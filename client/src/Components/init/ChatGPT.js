...
// openai.apiKey = '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';

const configuration = new Configuration({
	organization: 'org-n8QCCyimHn9iGsdQLI6sjmEc',
	apiKey: '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',
});
